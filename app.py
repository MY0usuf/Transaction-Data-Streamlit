    ...
    if submit_button:
        ...
        if project_area != 'All':
            if project_area == 'Sobha Hartland Phase 1':
                ...
                mask = (df['Project'] == 'Samana Mykonos Signature')|(df['Project'] == 'Samana Mykonos')|(df['Project'] == 'Samana Waves')|(df['Project'] == 'Samana Miami')|(df['Project'] == 'Samana Hills')|(df['Project'] == 'Samana Green')|(df['Project'] == 'Samana Skyros')|(df['Project'] == 'Samana Waves 2')|(df['Project'] == 'Samana Santorini')|(df['Project'] == 'Samana Golf View')|(df['Project'] == 'Samana Park Views')|(df['Project'] == 'Samana Golf Avenue')|(df['Project'] == 'Samana Ivy Gardens')|(df['Project'] == 'Miami By Sd')|(df['Project'] == 'Samana Portofino')|(df['Project'] == 'California By Sd')
