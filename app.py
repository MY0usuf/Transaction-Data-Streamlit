...
projects_areas = ['All','Sobha Hartland Phase 1','Samana All Projects','Al furjan in area','Iman Developers','Marquis Point Developements','Oro24 All Projects'] + sorted(df['Project'].unique().tolist()) + sorted(df['Area'].unique().tolist())
    ...
    if submit_button:
        ...
        if project_area != 'All':
            if project_area == 'Sobha Hartland Phase 1':
                ...
                mask = (df['Project'] == 'Samana Mykonos Signature')|(df['Project'] == 'Samana Mykonos')|(df['Project'] == 'Samana Waves')|(df['Project'] == 'Samana Miami')|(df['Project'] == 'Samana Hills')|(df['Project'] == 'Samana Green')|(df['Project'] == 'Samana Skyros')|(df['Project'] == 'Samana Waves 2')|(df['Project'] == 'Samana Santorini')|(df['Project'] == 'Samana Golf View')|(df['Project'] == 'Samana Park Views')|(df['Project'] == 'Samana Golf Avenue')|(df['Project'] == 'Samana Ivy Gardens')|(df['Project'] == 'Miami By Sd')|(df['Project'] == 'Samana Portofino')|(df['Project'] == 'California By Sd ')|(df['Project'] == 'Samana Barari Views 2')|(df['Project'] == 'Manhattan 2 By Sd')
            elif project_area == 'Al furjan in area':
                mask &= df['Area'] == 'Al Furjan'
            elif project_area == 'Oro24 All Projects':
                mask &= (df['Project'] == 'Kyoto By Oro24')|(df['Project'] == 'Torino By Oro24')|(df['Project'] == 'Elano By Oro24')|(df['Project'] == 'Levanto By Oro24')
